...
@Provider
@ApplicationScoped
public class GlobalWebApplicationExceptionHandler implements ExceptionMapper<WebApplicationException> {
    ...
    public Response toResponse(WebApplicationException exception) {
        ...
        res.setCode(exception.getResponse().getStatus());
        res.setMessage(exception.getResponse().getStatusInfo().getReasonPhrase());
